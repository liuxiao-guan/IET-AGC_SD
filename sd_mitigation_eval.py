...
def main(args):
    ...
    #checkpath = "/root/autodl-tmp/stable-diffusion-v1-4"
    ...
    savepath = f"/root/autodl-fs/logs/DCR/mitigationSD/inf_{args.seed}/gen"
    if args.rand_noise_lam is not None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-nb","--nbatches", type=int, default=4000)
    ...
    parser.add_argument("--modelpath", type=str, default=None, help="A seed for reproducible training.")
    parser.add_argument("--modelstyle", type=str, default="instancelevel_blip")
